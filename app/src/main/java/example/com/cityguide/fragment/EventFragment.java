...
import example.com.cityguide.adapter.EventAdapter;
import example.com.cityguide.data.EventData;
...
//        }
        ...
        if (getContext() != null) {
            ...
            recyclerView.setAdapter(new EventAdapter(getContext(), EventData.fetchEvents(value,getContext())));
        }
    }
}
